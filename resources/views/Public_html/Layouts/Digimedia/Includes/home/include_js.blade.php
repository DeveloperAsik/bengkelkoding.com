<!-- Scripts -->
<script src="{{config('app.base_assets_uri')}}/templates/digimedia/vendor/jquery/jquery.min.js"></script>
<script src="{{config('app.base_assets_uri')}}/templates/digimedia/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="{{config('app.base_assets_uri')}}/templates/digimedia/assets/js/owl-carousel.js"></script>
<script src="{{config('app.base_assets_uri')}}/templates/digimedia/assets/js/animation.js"></script>
<script src="{{config('app.base_assets_uri')}}/templates/digimedia/assets/js/imagesloaded.js"></script>
<!-- <script src="{{config('app.base_assets_uri')}}/templates/digimedia/assets/js/custom.js"></script> -->

<script src="{{config('app.base_assets_uri')}}/libs/slick/slick/slick.js"></script> <!-- SweetAlert2 -->
