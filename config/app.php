...
switch (env('APP_ENV')) {
    case 'local' :
        ...
        $base_api_url = env('APP_URL_BASE_API_URL');
    ...
    case 'dev' :
        ...
        $base_api_url = env('APP_URL_BASE_API_URL_DEV');
        $base_json_uri = env('APP_URL_JSON_DEV');
        break;
}
return [
    'default_variables' => [
        'title_for_layout' => "Welcome to SPA website with Laravel"
    ],
    ...
    'base_static_uri' => $base_static_url .'__assets/',
