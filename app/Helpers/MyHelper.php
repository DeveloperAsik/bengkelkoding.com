...
class MyHelper {
    ...
    public static function is_jwt_valid($jwt, $secret = 'secret') {
        ...
        if ($user->expired_date < strtotime(date('Y-m-d H:i:s'))) {
            $is_expired = true;
            DB::table('tbl_user_tokens')->where('user_id', $user->user_id)->update([
                'is_logged_in' => 0,
                'is_expiry' => 1,
            ...
            $token_exist = DB::table('tbl_user_tokens AS a')->select('a.id', 'a.token')->where('a.user_id', '=', $user->user_id)->first();
    ...
    public static function weekend_listing(int $start, int $stop) {
        $day_add = 86400;
        $return = [];
        if ($start >= $stop)
            return false;
    ...
    public static function get_day_id($m) {
        $weeks = [
            ['name' => 'sun', 'alias' => 'Sunday'],
            ['name' => 'mon', 'alias' => 'Monday'],
            ['name' => 'tue', 'alias' => 'Tuesday'],
            ['name' => 'wed', 'alias' => 'Wednesday'],
            ['name' => 'thu', 'alias' => 'Thursday'],
            ['name' => 'fri', 'alias' => 'Friday'],
            ['name' => 'sat', 'alias' => 'Saturday']
        ];
        $resp = '';
    ...
    public static function get_weeks($date, $rollover) {
        $cut = substr($date, 0, 8);
        $daylen = 86400;
    ...
    public static function count_days($year, $month, $ignore) {
        $count = 0;
...
//eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoxLCJncm91cF9pZCI6MSwidXNlcl9uYW1lIjoiYWRtaW53ZWIiLCJ1c2VyX2VtYWlsIjoiYWRtaW5AZ21haWwuY29tIiwiY3JlYXRlX2RhdGUiOjE2NDQ5MzQ0MDIsImV4cGlyZWRfZGF0ZSI6MTY0NTAyMDgwMn0.IqejoaSl5PAB5Yvlv81Noa3s37yDlkfeJbwFy44G0QE
//eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoxLCJncm91cF9pZCI6MSwidXNlcl9uYW1lIjoiYWRtaW53ZWIiLCJ1c2VyX2VtYWlsIjoiYWRtaW5AZ21haWwuY29tIiwiY3JlYXRlX2RhdGUiOjE2NDQ5MzQ0MDIsImV4cGlyZWRfZGF0ZSI6MTY0NTAyMDgwMn0.IqejoaSl5PAB5Yvlv81Noa3s37yDlkfeJbwFy44G0QE
//eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoxLCJncm91cF9pZCI6MSwidXNlcl9uYW1lIjoiYWRtaW53ZWIiLCJ1c2VyX2VtYWlsIjoiYWRtaW5AZ21haWwuY29tIiwiY3JlYXRlX2RhdGUiOjE2NDQ5MzQ0MDIsImV4cGlyZWRfZGF0ZSI6MTY0NTAyMDgwMn0.IqejoaSl5PAB5Yvlv81Noa3s37yDlkfeJbwFy44G0QE